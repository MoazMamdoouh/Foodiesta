...
public class DetailsFragment extends Fragment  {
   ...
   private FirebaseAuth firebaseAuth ;
    ...
    private void sendCategoryNameToSearch(View view){
        com.example.foodiesta.Details.DetailsFragmentDirections.ActionDetailsFragmentToSearchFragment
    ...
    private void requestMealDetailById(){
        int id  = com.example.foodiesta.Details.DetailsFragmentArgs.fromBundle(getArguments()).getMealId();
